    ...
    <>
      <form id='login-box'>
        <div style={loginStyles}>
          ...
          />
          <div style={{position:'absolute',right:'.5rem',top:'5px',cursor:'pointer'}} onClick={() => setPasswordType(prev => prev === 'password' ? 'text' : 'password')}>
          <MdRemoveRedEye />
          </div>
          </div>
        
          <Link style={{fontSize:'12px',textAlign:'right',width:'220px',position:'relative',bottom:'15px',userSelect:'none'}} to='/account/reset-password'>FORGOT PASSWORD?</Link>
